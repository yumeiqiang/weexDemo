...
/* unused harmony export setCode */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constant_js__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_md5__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_md5___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_md5__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_qs__ = __webpack_require__(13);
      ...
      switch (method) {
        case 'GET':
          stream.fetch({
            ...
            headers: {
              ...
              validateValue: __WEBPACK_IMPORTED_MODULE_2_md5___default()(__WEBPACK_IMPORTED_MODULE_2_md5___default()((random + time).toString()) + v.key)
            }
          }, response => {
        ...
        case 'POST':
          stream.fetch({
            ...
            url: `${__WEBPACK_IMPORTED_MODULE_0__constant_js__["API"]}${path}`,
            type: 'json',
            body: __WEBPACK_IMPORTED_MODULE_3_qs___default.a.stringify(data),
            headers: {
              validateRandomNumber: random,
              validateTimestamp: time,
              cookie: v.cookie,
